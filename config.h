...
static uint32_t colors[][3]                = {
	/*               fg          bg          border    */
	[SchemeNorm] = { 0xbbbbbbff, 0x222222ff, 0x88ddffff },
	[SchemeSel]  = { 0xeeeeeeff, 0x222222ff, 0x88ddffff },
...
static const char *const autostart[] = {
        "wbg", "/home/haiminh256/Pictures/hoshino.jpg",
};
...
static const char *screenshot[] = {
    "sh", "-c",
    "grim \"$HOME/Pictures/screenshot-$(date +%H-%M_%d-%m).png\"", NULL
};
...
static const Key keys[] = {
    ...
    { MODKEY,                    XKB_KEY_e,          spawn,          {.v = browser} },
    { MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_E,          spawn,           {.v = fileBrowser}},
